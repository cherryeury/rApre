...
tbl = {
	...
	[20783] = {
		...
		unidentifiedResourceName = "후드",
		unidentifiedDescriptionName = { "Can be identified by using a ^990099Magnifier^000000." },
		identifiedDisplayName = "Hero Manteau",
		identifiedResourceName = "영웅의망토",
		identifiedDescriptionName = {
			...
			"^0000FFRefine Level +10^000000:",
			"FLEE +20",
			"Decreases damage taken from ^777777Neutral^000000 elemental attacks by 20%",
			"________________________",
			"When equipped with ^990099Devilring Card^000000:",
			"Increases damage taken from ^777777Neutral^000000 elemental attacks by 50%",
			"________________________",
			"^0000CCType:^000000 Garment",
			"^0000CCDefense:^000000 0",
			"^0000CCWeight:^000000 10",
